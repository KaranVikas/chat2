    ...
    <div>
        ...
        <div className="modal-dialog">
            ...
            <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel">selectedChat.chatName</h5>
            ...
            <div className="modal-footer">
                ...
                <button type="button" className="btn btn-danger" onClick={() => handleRemove(user)}>Save Leave Group</button>
            </div>
            </div>
        </div>
        </div>
